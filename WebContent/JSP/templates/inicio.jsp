...
<% if (false) { %> <jsp:include page="tools/cajaBuscador.jsp"></jsp:include> <% } %>  
...
<!-- panel semillas -->
	<div class="ui-layout-north pane pane-north" id="ui-layout-semillas" style="position: absolute; margin: 0px; top: 0px; bottom: auto; left: 0px; right: 0px; width: auto; z-index: 1; height: 34px; visibility: visible; display: block;">                
...
<!-- panel contenido principal(pie) -->  	
		<div id="pie">
			<ul>                     
				<li><a href="divingWeb/index.html" id="abre-copyright">DivingWeb &copy;</a></li>
				<li><a href="divingWeb.html" target="_blank">Ayuda</a></li>
				<li>Att. cliente: <a title="Contactar con Centro de atención al cliente" href="mailto:hernan.h.lopez@hotmail.com?subject=Atension al cliente">email</a></li>
				<li><a title="Ayúdenos a mejorar" href="mailto:hernan.h.lopez@hotmail.com?subject=Sugerencia sobre Proyecto 01">Mi Opinión</a></li>
		...
		<div class="content" id="westcontent" style="position: relative; visibility: visible;">
			...
			<div id="subpanel-terminos-buscados" class="subpanel">
				<h3 class="titulo-subpanel">
					<a href="#" id="TermBus" class="opened"><img title="Lupa" alt="Lupa" src="images/magnifier.png"> Términos Buscados</a>
				</h3>
				<div class="conTermBus contenido-subpanel">
					<ul class="listado-terminos"> 
						<li><span class="SearchTerm SearchTermRel">----------</span></li>
						<li><span class="field">Filtro</span> : <span class="SearchTerm">Todas</span></li>
					</ul>
					<div class="acciones-subpanel">  
						<span class="guardar-alerta-left"> 
							<img title="Guardar búsqueda como Alerta" alt="Guardar búsqueda como Alerta" src="images/guardaralerta.png">
								<a alt="Guardar búsqueda como Alerta" title="Guardar búsqueda como Alerta" class="saveSearchAlert">Guardar</a>
						</span>
					</div>  
				</div>
			</div>
			...
			<div class="subpanel" id="subpanel-resultados">
					<h3 class="titulo-subpanel"><a class="opened" id="Result" href="#">Buscar en los resultados</a></h3>
			...
			<div class="subpanel" id="subpanel-resultados-clasificados">
				<h3 class="titulo-subpanel"><a class="opened" id="Buscar" href="#"><img title="Etiqueta" alt="Etiqueta" src="images/tag_blue.png">Resultados clasificados</a></h3>
				<div class="contenido-subpanel">
			...
			<!--#subpanel-resultados-->
			<div class="subpanel" id="subpanel-resultados">
				<h3 class="titulo-subpanel"><a class="opened" id="Result" href="#"><img title="Lista de resultados" alt="Lista de resultados" src="images/text_list_bullets.png"> Resultados</a></h3>
				<div class="conResults contenido-subpanel">
					<p class="cont">
						<a href="">
