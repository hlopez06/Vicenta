...
delimiter /
CREATE PROCEDURE sp_cargaStock (in idProducto int,in cantidad int, in precio float(3),out resp int)
BEGIN
...
IF resp THEN
	...
	SET resp = 1;
ELSE
	INSERT INTO stock (idProducto,cantidad,precio) VALUES (idProducto,cantidad,precio) ;
	SET resp = 2;
END if;
